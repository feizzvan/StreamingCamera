...
public class UDPClient implements Runnable {
    ...
    final int S_PORT;
    final int chunkSize;
    byte[] data; //dữ liệu nén được gửi đi
    int nextPacketIndex; //STT của lần gửi tiếp theo
    boolean free; //Cờ kiểm tra client có sẵn hay không
    ...
    public UDPClient(int c_port, int s_port) {
        ...
        S_PORT = s_port;
        chunkSize = 1018;
        nextPacketIndex = 255; //Đánh dấu gói tin đầu tiên
        free = true;
    }
